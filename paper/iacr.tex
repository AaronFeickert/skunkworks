...
\item Define $\{Y_j\}_{j=0}^{m-1} \subset \G$ such that: $$Y_j \equiv \rho_jJ$$
\end{itemize}
...
\begin{itemize}
\item Define $\left\{f_{j,i}\right\}_{j=0,i=1}^{m-1,n-1}$ such that $f_{j,i} \equiv \sigma_{j,i}\xi + a_{j,i}$.
